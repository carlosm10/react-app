  ...
  return (
    ...
    <section className="specials">
        ...
        <div className="specials-cards">
            ...
            <img src="https://via.placeholder.com/400x250" alt="Greek Salad" />
            ...
            {/* CARD 2 */}
            <article className="card">
            <img src="https://via.placeholder.com/400x250" alt="Bruschetta" />
            <div className="card-body">
                <div className="card-title">
                <h3>Bruschetta</h3>
            ...
            {/* CARD 3 */}
            <article className="card">
            <img src="https://via.placeholder.com/400x250" alt="Lemon Dessert" />
            <div className="card-body">
                <div className="card-title">
                <h3>Lemon Dessert</h3>
    ...
    <section className="testimonials">
        ...
        <div className="testimonials-cards">
            ...
            <div className="user">
                <img src="https://via.placeholder.com/60" alt="Jane Doe" />
                <span>Jane</span>
            </div>
            ...
            <span className="rating">★★★★★</span>
            <div className="user">
                <img src="https://via.placeholder.com/60" alt="Mark Smith" />
                <span>Mark</span>
            </div>
            ...
            <span className="rating">★★★★★</span>
            <div className="user">
                <img src="https://via.placeholder.com/60" alt="Anna Lee" />
                <span>Anna</span>
            </div>
            ...
            <span className="rating">★★★★★</span>
            <div className="user">
                <img src="https://via.placeholder.com/60" alt="Paul Adams" />
                <span>Paul</span>
            </div>
